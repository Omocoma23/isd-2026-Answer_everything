...
USE_LAYOUT = os.getenv("LAB7_LAYOUT", "1") == "1"
...
[10] ⭐ หัวข้อปีและภาคการศึกษามีผลกับทุกแถวใต้หัวข้อนั้น
    ถ้าหน้ามีหัวข้อ เช่น
        "ปีที่ 3 ภาคการศึกษาที่ 1"
    ให้กำหนด
        year = 3
        semester = 1
    ให้กับรายวิชาทุกแถวที่อยู่ใต้หัวข้อนั้น
    จนกว่าจะพบหัวข้อปี/ภาคใหม่
    ห้ามใส่ null หรือ 0 ถ้าหน้าระบุปีและภาคไว้อย่างชัดเจน

[11] ⭐ คำว่า "วิชาเลือก" ไม่ได้แปลว่า year=0 เสมอ
    ถ้าวิชาเลือกปรากฏอยู่ใต้หัวข้อปี/ภาคที่ระบุชัด
    เช่น "ปีที่ 3 ภาคการศึกษาที่ 1"
    ต้องใส่ year=3, semester=1 ตามหัวข้อนั้น
    และ flexible_year_semester = null
...
[12] ⭐ หนึ่งแถวในตาราง = หนึ่ง object (รหัสซ้ำต่างชื่อหรือลำดับต้องแยกแถว)
    ...
    ตัวอย่าง:
        06026xxx วิชาเลือกกลุ่มวิทยาการข้อมูล 1
                  วิชาเลือกกลุ่มการวิเคราะห์เชิงสถิติ 1
                  วิชาเลือกกลุ่มวิศวกรรมข้อมูล 1

    ต้องสร้างเพียง 1 object โดยรวมชื่อทั้งสามไว้ใน name_th
    คั่นแต่ละชื่อด้วย \n และรวมชื่ออังกฤษทั้งสามไว้ใน name_en เช่นเดียวกัน
